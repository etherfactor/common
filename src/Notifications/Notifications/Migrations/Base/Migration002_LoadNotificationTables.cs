...
public class Migration002_LoadNotificationTables : MigrationExtension
{
    public override void Up()
    {
        ...
        Insert.IntoTable("notification_subscriptions")
            .Row(new { user_id = "ABC", event_type = "test.domain.event", channel_key = "webhook", channel_config = "{\"method\":\"POST\",\"endpoint\":\"https://localhost:52227/webhook/post\",\"headers\":{}}", schedule_type = "immediate", schedule_config = "{}", is_enabled = true })
            .Row(new { user_id = "ABC", event_type = "test.domain.event", channel_key = "webhook", channel_config = "{\"method\":\"POST\",\"endpoint\":\"https://localhost:52227/webhook/post\",\"headers\":{}}", schedule_type = "digest", schedule_config = "{\"cronExpression\":\"* * * * *\"}", is_enabled = true })
            .Row(new { user_id = "DEF", event_type = "test.domain.event", channel_key = "webhook", channel_config = "{\"method\":\"POST\",\"endpoint\":\"https://localhost:52227/webhook/post\",\"headers\":{}}", schedule_type = "immediate", schedule_config = "{}", is_enabled = true });
    }
