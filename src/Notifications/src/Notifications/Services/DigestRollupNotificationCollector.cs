...
internal class DigestRollupNotificationCollector : NotificationCollector
{
    ...
    public DigestRollupNotificationCollector(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        foreach (var subscription in subscriptions)
        {
            ...
            activity?.SetTag("notification.schedule", NotificationSchedules.Digest.Id);
        ...
        where TEvent : class, IDomainEvent
    {
        ...
        await _emitter.EmitAsync(
            digest,
            audience: new("$sub", subscription.Id.ToString()),
            options: new()
            {
                IsDerived = true,
            },
