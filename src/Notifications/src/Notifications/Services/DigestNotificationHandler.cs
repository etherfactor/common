...
internal class DigestNotificationHandler : INotificationHandler
{
    ...
    public DigestNotificationHandler(
        ILogger<DigestNotificationHandler> logger,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (!claim.Notification.IsDerived)
        {
            await _coordinator.MarkReleasedAsync(claim, cancellationToken: cancellationToken);
            return;
        }
