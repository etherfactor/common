...
{
    private Lazy<DigestNotificationHandler> _handler;
    private Mock<ILogger<DigestNotificationHandler>> _loggerMock;
    ...
    [Test]
    public async Task HandleAsync_WhenDispatchSucceedsNotDerived_ShouldNotMarkSent()
    {
        //Arrange
        var notification = new Notification { Id = 123, IsDerived = false, Subscription = new() { } };
    ...
    [Test]
    public async Task HandleAsync_WhenDispatchSucceedsDerived_ShouldMarkSent()
    {
        //Arrange
        var notification = new Notification { Id = 123, IsDerived = true, Subscription = new() { } };
        var claim = new NotificationClaim(123, notification, Guid.NewGuid());
    ...
    private static void VerifyLogged(
        Mock<ILogger<DigestNotificationHandler>> logger,
        LogLevel level,
